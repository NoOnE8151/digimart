  ...
  return (
    <div className='grid justify-items-start gap-3 h-full w-full relative px-5 md:px-[7rem] py-[6rem]'>
      ...
      <div className='bg-muted w-full flex flex-col md:flex-row gap-5 justify-between p-8 rounded-lg shadow'>
        ...
        {subMerchant && !isSubMerchantFetching && <button onClick={handleKYC} className='bg-element text-white font-semibold max-h-[3rem] px-5 md:py-0 py-3 rounded-xl cursor-pointer hover:bg-element-hover active:bg-element-active'>Complete KYC</button>}
      </div>
        </div>
